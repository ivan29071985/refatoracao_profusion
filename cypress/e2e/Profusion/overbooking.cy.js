...
describe.only('Overbooking', () => {
    ...
    it('Validar fluxo na criação do bloqueio dentro do bloqueio de agenda com Overbooking 18.1', () => {

        const horaInicial = '17:40'
        const horaFinal = '17:50'
        const baseUrl = Cypress.env('currentBaseUrl');
        cy.visit(baseUrl);
        cy.wait(2000)
        cy.get('#register').click()
        ...
        if (dayOfWeekSelector) {
            ...
            cy.wait(3000)
            cy.contains('div', 'Já existe uma grade ativa na Unidade Automação Staging com o mesmo intervalo de dias e/ou horários. Para prosseguir, ajuste o período selecionado e tente novamente.')
                .should('be.visible')
            cy.wait(2000)    
            cy.contains('button', 'Ok')
                .click()
    ...
    it('Validar fluxo para edição do bloqueio da agenda com Overbooking 19', () => {
        ...
        cy.contains('span', 'Horários de atendimento').click()
        cy.wait(2000)
        cy.xpath("(//button[.//mat-icon[contains(text(), ' edit ')]])").first().click({ timeout: 5000 })
        cy.get('input[formcontrolname="description"]')
            .clear()
    ...
    it.only('Validar liberação de Slot ao desmarcar agendamento da grade com Overbooking feito por encaixe 1', () => {
        const baseUrl = Cypress.env('currentBaseUrl');
        cy.visit(baseUrl);
        cy.wait(2000)
        cy.get('#schedule')
    ...
    it('Validar liberação de Slot ao desmarcar agendamento da grade com Overbooking feito por encaixe 2', () => {
        const baseUrl = Cypress.env('currentBaseUrl');
        cy.visit(baseUrl);
        cy.wait(2000)
        cy.get('#schedule')
    ...
    it('Validar liberação de Slot ao desmarcar agendamento da grade com Overbooking feito por encaixe 3', () => {
        const baseUrl = Cypress.env('currentBaseUrl');
        cy.visit(baseUrl);
        cy.wait(2000)
        cy.get('#schedule')
    ...
    it('Validar liberação de Slot ao desmarcar agendamento da grade com Overbooking feito por encaixe 4', () => {
        const baseUrl = Cypress.env('currentBaseUrl');
        cy.visit(baseUrl);
        cy.wait(2000)
        cy.get('#schedule')
