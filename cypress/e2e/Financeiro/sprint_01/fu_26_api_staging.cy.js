...
describe('fu_26', () => {
  it('Validar API POST - Login > 200', () => {
      cy.request({
          method: 'POST',
          url: 'https://amei-staging.amorsaude.com.br/api/v1/security/login',
          body: {
  ...
  it('Validar API POST refresh token > 201', () => {
      cy.request({
          ...
          cy.request({
              method: 'POST',
              url: 'https://amei-staging.amorsaude.com.br/api/v1/security/refresh-token?clinicId=483',
              headers: {
  ...
  it('Validar para que todos usuários pertencem a clínica logada > 483', () => {
      ...
      cy.request({
          ...
          cy.request({
              ...
              cy.request({
                  method: 'GET',
                  url: 'https://amei-staging.amorsaude.com.br/api/v1/user/by-clinic',
                  headers: {
  ...
  it('Validar para que todos usuários pertencem a clínica logada > 503', () => {
      ...
      cy.request({
          ...
          cy.request({
              method: 'POST',
              url: 'https://amei-staging.amorsaude.com.br/api/v1/security/refresh-token?clinicId=503',
              headers: {
                  'Authorization': `Bearer ${token}`,
              },
              failOnStatusCode: false
